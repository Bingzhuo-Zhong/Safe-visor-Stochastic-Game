"""
This script initializes the DDPG agents and defines the DDPG-related operations
"""


import os
from rein.utils import OrnsteinUhlenbeckActionNoise
from rein.agent.base import BaseAgent, BaseAgentParams
...
class DDPGAgent(BaseAgent):
    ...
    def __init__(self, params: DDPGAgentParams, shape_observations=14, shape_action=4, on_edge=False):
        ...
        # we use OU-Noise for exploration
    ...
    def soft_update(self):
        """
            Soft update
            As shown in DDPG algorithm, the weights of actor-critic are slowly copied to target networks
        """
